...
const ItemCtrl = (function() {
    ...
    const data = {
        // items: [
        //     { id: 0, name: 'Online Course', cost: 100 },
        //     { id: 1, name: 'Personal Accs', cost: 250 },
        //     { id: 2, name: 'Home Rent', cost: 750 }
        // ],
    ...
    return {
        ...
        addItem: function(name, cost) {
            ...
            // Turn cost into number
            cost = parseInt(cost);

            // Create new item
            newItem = new Item(ID, name, cost);

            // Push new item in data structure array
        ...
        getTotalExpense: function() {
            ...
            // Set total expense in data structure
    ...
    return {
        populateItemList: function(items) {
            ...
            items.forEach(function(item) {
                ...
                <strong>${item.name}:  </strong> <em class="pull-right"><strong>$${item.cost}</strong></em>
                <a href="#" class="">
        ...
        addListItem: function(item) {
            ...
            li.id = `item-${item.id}`;
            // Add HTML
            li.innerHTML = `<strong>${item.name}:  </strong> <em class="pull-right"><strong>$${item.cost}</strong></em>
                            <a href="#" class="">
                                <i class="edit-item fa fa-pencil-square-o"></i>
                            </a>`;
        ...
        updateListItem: function(item) {
            ...
            listItems.forEach(function(listItem) {
                ...
                if (itemID === `item-${item.id}`) {
                    document.querySelector(`#${itemID}`).innerHTML = `<strong>${item.name}:  </strong> <em class="pull-right"><strong>$${item.cost}</strong></em>
                    <a href="#" class="">
                        <i class="edit-item fa fa-pencil-square-o"></i>
                    </a>`;
                }
        ...
        showTotalExpense: function(totalExpense) {
            document.querySelector(UISelectors.totalExpense).textContent = totalExpense;
        },
...
const App = (function(ItemCtrl, StorageCtrl, UICtrl) {
    ...
    const itemAddSubmit = function(e) {
        ...
        if (input.name !== '' && input.cost !== '') {
            ...
            UICtrl.showTotalExpense(totalExpense);
